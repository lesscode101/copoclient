...
// Lazy load SortByDropdown لتقليل TBT
const SortByDropdown = dynamic(() => import('@/app/components/Filter/SortByDropdown'), { ssr: false });
...
const SectionContent = ({ initialProducts, categoryName }: Props) => {
