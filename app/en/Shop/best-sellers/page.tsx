...
export default async function BestSellersPage() {
    ...
    // SEO metadata
    const title = "Best Seller Backpacks in Morocco | Durable & Stylish | Eravist";
    const desc =
        "Discover best seller backpacks in Morocco. High-quality, durable, and stylish backpacks for work, travel, and everyday use. Free shipping across Morocco.";
    ...
    return (
        <>
            ...
            <ListContent products={products} titleName="Best-selling" />
